// Local mirror of packages/shared-types/src/import.ts (M2.5 — DECISIONS D-202 mirror policy).
...
/** Statuses during which the batch is still being processed (progress bar active). */
export const IMPORT_PROCESSING_STATUSES: ImportBatchStatus[] = [
  'uploaded',
  'parsing',
  'validating',
  'resolving',
...
/** Rollback is only offered for a published batch (Spec §12). */
export const IMPORT_ROLLBACKABLE_STATUSES: ImportBatchStatus[] = ['published'];
